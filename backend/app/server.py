...
from .api_singing import router as singing_router
...
application = FastAPI(title="BeatMaster API", version="1.1.0", lifespan=lifespan)
application.include_router(system_router)
application.include_router(projects_router)
application.include_router(processing_router)
application.include_router(singing_router)
